...
const findings: Finding[] = [
  ...
  },
  {
    ...
    priority: "P0",
    agent: "Data & Privacy",
    title: "No GDPR data processing agreement with Alpina Bank",
    ...
    remediation: "Execute GDPR Article 28 DPA with Alpina Bank before any data processing. Use the standard SavanoAI DPA template.",
    effort: "3 days",
  },
  {
    id: "OP-001",
    ...
    description: "No Azure Monitor, no alerting, no logging configured. Alpina Bank's IT Operations Runbook requires P1 incident resolution within 4 hours. Without monitoring, incidents won't even be detected.",
